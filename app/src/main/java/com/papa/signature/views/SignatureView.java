...
import com.papa.signature.utils.Bezier;
import com.papa.signature.utils.ControlTimedPoints;
import com.papa.signature.utils.TimedPoint;
...
public class SignatureView extends View {
    ...
    public SignatureView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mMaxWidth = a.getDimensionPixelSize(R.styleable.SignatureView_maxWidth, convertDpToPx(6));//原来的值是20
...
//		mPaint.setStrokeWidth(4);           //画笔粗细
//		mPaint.setTextSize(12);             //绘制文字大小，单位px
